...
try:
    ...
    # Запускаем второй скрипт с кодировкой utf-8 для того чтобы значения аттрибутов на русском языке отображались exec(open('course_script.py', 'r', encoding='utf-8').read())
